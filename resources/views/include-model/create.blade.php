{{-- resources/views/include-model/create.blade.php --}}
<x-app-layout>
    <div>
        <div class="mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white border dark:bg-gray-800 sm:rounded-lg p-6">
                <form action="{{ route('include.store') }}" method="POST" class="space-y-6">
                    @csrf
                            ...
                            <select id="pemesanan_id" name="pemesanan_id" required
                                ...
                                @foreach ($pemesanan as $p)
                                    <option value="{{ $p->pemesanan_id }}"
                                        ...
                                        {{ $p->pemesanan_id }} – {{ Str::limit($p->nama_pemesan ?? $p->id, 20) }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
